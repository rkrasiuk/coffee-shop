  ...
  <div>
    ...
    <List>
      <ListItem
        ...
        rightAvatar={<FloatingActionButton mini disabled>1.5$</FloatingActionButton>} />
      <ListItem
        primaryText='Caffe Latte'
        secondaryText={<s>4$</s>}
        leftAvatar={<Avatar src={'images/CaffeLatte.jpg'} />}
        rightAvatar={<FloatingActionButton mini disabled>3$</FloatingActionButton>} />
      <ListItem
        primaryText='Iced Passion Tango Tea Lemonade'
        secondaryText={<s>4$</s>}
        leftAvatar={<Avatar src='images/IcedPassionTangoTeaLemonade.jpg' />}
        rightAvatar={<FloatingActionButton mini disabled>3.5$</FloatingActionButton>} />
    </List>
  </div>
)
